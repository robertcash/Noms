//
//  EatDetailDescriptionViewController.m
//  Eats
//
//  Created by Robert Cash on 1/25/16.
...
@interface EatDetailDescriptionViewController ()
...
@implementation EatDetailDescriptionViewController{
    // Data
...
/**
 TODO: Add description and edit share to include time.
...
-(void)setUpUI{
    ...
    self.descriptionLabel.text = self.nom.facebookDescription;
...
-(CGSize)heightForCellWithString:(NSString *)stringValue withFont:(UIFont *)font{
